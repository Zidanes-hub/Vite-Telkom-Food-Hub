  ...
  return (
    <div ref={ref} className={`bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-700 ease-out opacity-0 translate-y-10 delay-${index * 100} h-full`}>
      <div className="p-8">
        ...
        <p className="text-gray-600 mt-3 h-24 overflow-hidden">
          {outlet.description}
        </p>
        <Link to={`/outlet/${outlet.slug}`} className="mt-6 inline-block bg-gray-800 text-white font-semibold py-3 px-6 rounded-lg hover:bg-gray-900 transition-colors transform hover:-translate-y-0.5">
          KUNJUNGI WARUNG
        </Link>
      </div>
    </div>
...
const HomePage: React.FC = () => {
  ...
  const carouselItems = [
    { id: 1, title: 'Pesan dari Asrama', description: 'Jelajahi menu dari warung favoritmu langsung dari HP, nggak perlu keluar kamar.', icon: <FiSmartphone /> },
    { id: 2, title: 'UMKM Terima Pesanan', description: 'Pesananmu via WhatsApp langsung diterima oleh pemilik warung untuk disiapkan.', icon: <FiCheckSquare /> },
    { id: 3, title: 'Diantar ke Lokasimu', description: 'UMKM akan mengirimkan pesananmu ke asrama atau titik lokasi yang kamu tentukan.', icon: <FiTruck /> },
  ];
  ...
  return (
    <Layout>
      ...
      <section ref={howToOrderRef} id="how-to-order" className="py-16 md:py-24 bg-white opacity-0 translate-y-10 transition-all duration-700 ease-out">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold font-poppins text-gray-800 mb-12">Cara Pesan? Gampang Banget!</h2>
      ...
      <section ref={mitraSliderRef} id="mitra-slider" className="py-16 md:py-24 bg-gray-800 text-white opacity-0 translate-y-10 transition-all duration-700 ease-out">
        <div className="container mx-auto px-4 text-center">
            ...
            >
              {[...Array(2)].map((_, i) => (
                <React.Fragment key={i}>
                  {mitraImages.map((src, j) => ( // Loop berdasarkan array mitraImages
                    <img
                      key={`${i}-${j}`}
                      src={src}
                      alt={`Mitra ${j + 1}`}
      ...
      <section ref={ourMissionRef} id="our-mission" className="py-16 md:py-24 bg-white opacity-0 translate-y-10 transition-all duration-700 ease-out">
        <div className="container mx-auto px-4">
      ...
      <section ref={joinCtaRef} id="join-cta" className="py-16 md:py-24 bg-red-600 text-white text-center opacity-0 translate-y-10 transition-all duration-700 ease-out">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold font-poppins">Punya Usaha Kuliner di Sekitar Telkom?</h2>
          <p className="mt-4 text-lg">Jangkau lebih banyak mahasiswa dan jadi bagian dari komunitas kami. Gratis, tanpa komisi.</p>
          <Link to="/partner" className="mt-8 inline-block bg-white text-red-600 font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            Gabung Jadi Mitra
          </Link>
        </div>
      </section>

      <section ref={feedbackRef} id="feedback" className="py-16 md:py-24 bg-white text-center opacity-0 translate-y-10 transition-all duration-700 ease-out">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold font-poppins text-gray-800">Punya Kritik atau Saran?</h2>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">Kami terus berusaha menjadi lebih baik. Setiap masukan darimu sangat berharga. Hubungi Customer Service kami via WhatsApp.</p>
          <a href="https://wa.me/6281232891289?text=Halo%20Admin%20Telkom%20Food%20Hub,%20saya%20ingin%20memberikan%20masukan..." target="_blank" rel="noopener noreferrer" className="mt-8 inline-block bg-green-500 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:bg-green-600 transform hover:-translate-y-1 transition-all duration-300">
