    ...
    <header className="bg-white/80 backdrop-blur-lg sticky top-0 z-50 shadow-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav>
            <Link to="/" className="text-gray-600 hover:text-red-600 transition-colors font-semibold">← Kembali ke Beranda</Link>
          </nav>
        </div>
      </div>
    </header>
...
const BenefitCard: React.FC<{ icon: string, title: string, description: string }> = ({ icon, title, description }) => (
    <div className="bg-white p-8 rounded-2xl shadow-lg text-center transform hover:-translate-y-2 transition-transform duration-300">
        <div className="w-16 h-16 bg-red-100 text-red-600 text-3xl font-bold rounded-full flex items-center justify-center mx-auto mb-6">{icon}</div>
      ...
      <main>
        <section id="partnership-hero" className="bg-red-600 text-white text-center py-20">
            <div className="container mx-auto px-4">
                <h1 className="text-4xl md:text-5xl font-extrabold font-poppins">Keuntungan Menjadi Mitra Telkom Food Hub</h1>
        ...
        <section id="partnership-cta" className="py-16 md:py-20 bg-gray-100">
            <div className="container mx-auto px-4 text-center">
                <h2 className="text-3xl font-bold text-gray-800 mb-6">Siap Mengembangkan Usaha Anda?</h2>
                <a 
