  ...
  return (
    <div className='bg-gray-50'>
      ...
      <main>
        <section
          id='hero-detail'
          className='relative h-[50vh] flex items-center justify-center text-white text-center'
        >
          <div className='absolute inset-0 bg-red-800'></div>
          <div className='absolute inset-0 bg-black/50'></div>
          <div className='relative z-10 p-4'>
            <h1 className='text-4xl md:text-6xl font-extrabold font-poppins capitalize'>
              {outlet.name}
            </h1>
            ...
            <a
              ...
              className='mt-8 inline-flex items-center gap-2 bg-green-500 text-white font-bold py-3 px-6 rounded-full shadow-lg hover:bg-green-600 transform hover:scale-105 transition-all duration-300'
            >
              <svg
        ...
        <section id='menu-detail' className='py-16 md:py-24'>
          <div className='container mx-auto px-4'>
            <h2 className='text-3xl md:text-4xl font-bold font-poppins text-center text-gray-800 mb-12'>
              Menu Lengkap
            </h2>
