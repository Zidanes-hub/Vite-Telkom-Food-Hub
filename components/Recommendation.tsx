...
const SparklesIcon: React.FC<{ className: string }> = ({ className }) => (
  ...
  >
    <path
      ...
      strokeWidth={2}
      d='M5 3v4M3 5h4M6 17v4m-2-2h4m11-1a2 2 0 00-2-2h-1a2 2 0 00-2 2v1a2 2 0 002 2h1a2 2 0 002-2v-1zM17 3a2 2 0 00-2 2v1a2 2 0 002 2h1a2 2 0 002-2v-1a2 2 0 00-2-2h-1z'
    />
  </svg>
);
...
const Recommendation: React.FC = () => {
  ...
  return (
    <div className='bg-white p-6 rounded-2xl shadow-lg border border-red-100 text-center'>
      ...
      <h3 className='text-xl font-bold mt-4 mb-2 font-poppins text-gray-800'>
        Bingung Mau Makan Apa?
      </h3>
      <p className='text-gray-600 mb-6'>
        Biar AI kami yang pilihkan menu spesial untukmu hari ini!
      </p>
